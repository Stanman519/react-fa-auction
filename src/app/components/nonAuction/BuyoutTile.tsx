      ...
      {showModal &&
        ...
        cutCandidates[selectedPlayerIndex!].salary && (
          <ConfirmModal
            ...
            mainText={
              "Are you sure you want to use your buyout? You only get 1 every season and it costs $15 IRL!"
            }
            onAction={() => {
              dispatch(
                submitBuyout(
            ...
            {selectedPlayerIndex !== undefined && (
              <div className="flex flex-row justify-center content-center m-3">
                <Button
                  ...
                  onClick={() =>
                    dispatch(updateUI({ modal: "buyout-confirm" }))
                  }
                >
                  <div className="flex flex-row justify-center content-center pl-3 pr-4 pt-2 pb-2 ">
                    ...
                    <div className="lg:text-2xl text-white">
                      BUYOUT THIS PLAYER - 20% dead cap this year only
                    </div>
                  </div>
                </Button>
              </div>
