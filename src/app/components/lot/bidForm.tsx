...
export const BidForm = ({
  ...
  const getValidity = () => {
    if (!currentLeague)
      return { violations: ["You are not logged in."] } as BidValidity;
    ...
    <div style={bidFormStyle}>
      <div style={{ display: "flex", justifyContent: "space-around" }}>
        <TextField
          ...
          label="Years"
          type="number"
          InputProps={{ inputProps: { min: 0, max: 5, inputMode: "numeric" } }}
        />
        <TextField
          value={bidSalary}
          ...
          type="number"
          InputProps={{
            inputProps: { min: 0, max: 500, inputMode: "numeric" },
          }}
        />
        <Tooltip
          title={
