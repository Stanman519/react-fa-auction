...
import { FormControl, InputLabel, MenuItem, Paper, Select, SelectChangeEvent, Table, TableCell, TableContainer, TableHead, TableRow } from '@mui/material';
...
function AuctionRosters() {
  ...
  const dispatch = useDispatch();
    ...
    const [selection, setSelection] = useState<RosterOwner|undefined>(undefined)
  ...
  return (
    ...
    <div style={{marginLeft: 8, marginRight: 8}}>
        ...
        <FormControl style={{marginTop: 8, marginRight: 16, marginLeft: 16, width: '50%'}}  >
