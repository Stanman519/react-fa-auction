...
export const checkValidity = (
  ...
  if (newBid + bidsOnBoard > league.capRoom) {
    validity.isValid = false;
    validity.violations.push(
      "This and your current high bids would put you over the cap.",
    );
  }
  if (newYears > 5) {
    validity.isValid = false;
  ...
  if (newBid + newYears * 5 <= oldBid + oldYears * 5) {
    ...
    validity.violations.push(
      `Old bid contract value: ${old}. Yours: ${newB} (Years x 5 + salary)`,
    );
  }
...
export const tmColorMap: TmColor[] = [
  ...
  },
  {
    ...
    primary: "#008E97",
    secondary: "#FC4C02",
    logo: "https://loodibee.com/wp-content/uploads/nfl-miami-dolphins-logo-2018.png",
  },
  {
    team: "NEP",
    nickname: "Patriots",
  ...
  },
  {
    ...
    primary: "gray",
    secondary: "black",
    logo: "https://loodibee.com/wp-content/uploads/nfl-league-logo.png",
  },
];
